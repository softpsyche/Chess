...
namespace Arcesoft.Chess.Implementation
{
    internal class ThreatProvider
    {
        ...
        /// <returns></returns>
        public Dictionary<BoardLocation, ThreatDirection?> FindThreatsForPlayer(Board board, Player player)
        {
            ...
            Dictionary<BoardLocation, ThreatDirection?> threatenedBoardLocations = new Dictionary<BoardLocation, ThreatDirection?>();

            opposingPieceLocations
                .ForEach(a => AddThreats(board, player, playerKingLocation, a, threatenedBoardLocations));
        ...
        /// <returns></returns>
        public Dictionary<BoardLocation, ThreatDirection?> FindThreatsForBoardLocation(Board board, BoardLocation boardLocation)
        {
            Dictionary<BoardLocation, ThreatDirection?> threatenedBoardLocations = new Dictionary<BoardLocation, ThreatDirection?>();
            ...
            {
                AddThreats(board, player, board.GetKingsLocation(player), boardLocation, threatenedBoardLocations);
            }
        ...
        private void AddThreats(
            ...
            Dictionary<BoardLocation, ThreatDirection?> threatenedBoardLocations)
        {
            ...
            switch (chessPiece)
            {
                ...
                case ChessPiece.WhitePawn:
                    AddPawnThreats(board, player, playerKingLocation, opposingPieceBoardLocation, threatenedBoardLocations);
                    break;
                case ChessPiece.BlackRook:
                case ChessPiece.WhiteRook:
                    AddRookThreats(board, player, playerKingLocation, opposingPieceBoardLocation, threatenedBoardLocations);
                    break;
                case ChessPiece.BlackKnight:
                case ChessPiece.WhiteKnight:
                    AddKnightThreats(board, player, playerKingLocation, opposingPieceBoardLocation, threatenedBoardLocations);
                    break;
                case ChessPiece.BlackBishop:
                case ChessPiece.WhiteBishop:
                    AddBishopThreats(board, player, playerKingLocation, opposingPieceBoardLocation, threatenedBoardLocations);
                    break;
                ...
                case ChessPiece.WhiteKing:
                    AddKingThreats(board, player, opposingPieceBoardLocation, threatenedBoardLocations);
                    break;
                default:
            ...
            Dictionary<BoardLocation, ThreatDirection?> threatenedBoardLocations)
        {
            ...
            possibleMoves
                .ForEach(a => AddThreat(threatenedBoardLocations, a, ThreatDirection.Direct));
        }
            ...
            Dictionary<BoardLocation, ThreatDirection?> threatenedBoardLocations)
        {
            opposingPieceBoardLocation
                .Neighbors()
                .ForEach(a => AddThreat(threatenedBoardLocations, a));
        }
        ...
        {
            //horizontal
            AddDirectionalThreats(board, player, playerKingLocation, opposingPieceBoardLocation, Direction.East, threatenedBoardLocations);
            AddDirectionalThreats(board, player, playerKingLocation, opposingPieceBoardLocation, Direction.West, threatenedBoardLocations);

            //vertical
            AddDirectionalThreats(board, player, playerKingLocation, opposingPieceBoardLocation, Direction.North, threatenedBoardLocations);
            AddDirectionalThreats(board, player, playerKingLocation, opposingPieceBoardLocation, Direction.South, threatenedBoardLocations);
        }
        ...
        {
            //slope
            AddDirectionalThreats(board, player, playerKingLocation, opposingPieceBoardLocation, Direction.NorthWest, threatenedBoardLocations);
            AddDirectionalThreats(board, player, playerKingLocation, opposingPieceBoardLocation, Direction.SouthEast, threatenedBoardLocations);

            //grade
            AddDirectionalThreats(board, player, playerKingLocation, opposingPieceBoardLocation, Direction.SouthWest, threatenedBoardLocations);
            AddDirectionalThreats(board, player, playerKingLocation, opposingPieceBoardLocation, Direction.NorthEast, threatenedBoardLocations);
        }
        ...
        private void AddThreat(Dictionary<BoardLocation, ThreatDirection?> threatenedBoardLocations, BoardLocation boardLocation, ThreatDirection? pin = null)
        {
            ...
            else
            {
                ...
                if (pin != null)
                {
                    var existingValue = threatenedBoardLocations[boardLocation];

                    if (existingValue.HasValue)
                    {
                        threatenedBoardLocations[boardLocation] |= pin;
                    }
                    else
                    {
                        threatenedBoardLocations[boardLocation] = pin;
